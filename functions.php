...
if ( ! function_exists( 'test_task_setup' ) ) :
	...
	function test_task_setup() {
		...
		register_nav_menus( array(
			...
			'menu-top' => esc_html__( 'Top menu', 'test_task' ),
			'menu-footer' => esc_html__( 'Footer menu', 'test_task' ),
		) );
...
function test_task_scripts() {
	...
	wp_enqueue_style( 'test_task-fontawesome', "https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css");
	wp_enqueue_style( 'slick', "https://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.css");
	wp_enqueue_style('test_task-main-style', get_template_directory_uri() . '/css/main.css');

	wp_enqueue_script( 'slick', "https://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.min.js", array('jquery'), '20151215', true );
	wp_enqueue_script( 'test_task-main-script', get_template_directory_uri() . '/js/main.js', array('jquery'), '20151215', true );
